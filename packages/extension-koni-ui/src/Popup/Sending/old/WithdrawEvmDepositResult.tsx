...
function SendFundResult ({ className = '', failResultText = 'Withdraw Evm Deposit Fail', networkKey, onResend, successResultText = 'Withdraw EVM Deposit Successful', txResult: { extrinsicHash, isTxSuccess, txError } }: Props): React.ReactElement<Props> {
