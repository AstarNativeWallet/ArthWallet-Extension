...
function SendEvmFundResultEvmToEvmDeposit ({ className = '', failResultText = 'Send Fund Fail', networkKey, onResend, successResultText = 'Send Fund Successful', txResult: { extrinsicHash, isTxSuccess, txError } }: Props): React.ReactElement<Props> {
...
export default React.memo(styled(SendEvmFundResultEvmToEvmDeposit)(({ theme }: ThemeProps) => `
  margin: 20px 45px 0;
