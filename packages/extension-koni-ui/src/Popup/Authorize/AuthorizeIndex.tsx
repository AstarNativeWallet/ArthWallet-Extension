...
function AuthorizeIndex ({ className, index, name, onNextClick, onPreviousClick, totalItems }: Props): React.ReactElement<Props> {
  ...
  return (
    <div className={className}>
      <div className='authorize-index-wrapper'>
...
export default styled(AuthorizeIndex)(({ theme }: ThemeProps) => `
