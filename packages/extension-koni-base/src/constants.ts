...
// export const CRON_AUTO_RECOVER_DOTSAMA_INTERVAL = 6000000000;
...
export const CRON_REFRESH_HISTORY_INTERVAL = 10000;

export const ALL_ACCOUNT_KEY = 'ALL';
export const IGNORE_GET_SUBSTRATE_FEATURES_LIST = 'astarEvm';
